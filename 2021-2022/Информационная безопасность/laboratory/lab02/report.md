...
![Пользователи](image/2.jpg){ #fig:002 width=70% }

![Вход в систему с guest](image/3.jpg){ #fig:003 width=70% }
...
![Команда cat /etc/passwd](image/5.jpg){ #fig:005 width=70% }

![Сожержимое файла /etc/passwd](image/6.jpg){ #fig:006 width=70% }
...
![Правильность выполнения команды](image/8.jpg){ #fig:008 width=70% }
...
![Снятие атрибутов с директории](image/9.jpg){ #fig:009 width=70% }

![Содержимое папки dir1](image/10.jpg){ #fig:010 width=70% }
